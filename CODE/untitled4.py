...
Original file is located at
    https://colab.research.google.com/drive/1HMP1hiIBdIsJwwYmKooOTe_hB100YfVj
"""
...
def data():
    ...
    stoplist = (
        open('/content/drive/My Drive/Data Instagram/Stopwords/tala-stopword.txt', 'r').read().replace('\n', ' ')).split(
        " ")
    ...
    num_epochs = 10
    batch_size = 32
    namew2v = '/content/drive/My Drive/Data Instagram/w2v/Word2Vec15windowbalanced'
    ...
    X_train, X_val, y_train, y_val = sklearn.model_selection.train_test_split(X, y, test_size=0.2, stratify=y,
                                                                              random_state=sd)
    return X_train, y_train, X_val, y_val, train_embedding_weights, MAX_SEQUENCE_LENGTH, len(train_word_index) + 1
...
def model(X_train, y_train, X_val, y_val):
    ...
    '''
    reset_seeds()
    embedding_layer = tensorflow.keras.layers.Embedding(len(train_word_index) + 1,
                                             100,
    ...
    init = tensorflow.keras.initializers.random_normal(seed=0)
    ...
    drops1 = tensorflow.keras.layers.Dropout(drop1, seed=0)(l_merge)
    dense = tensorflow.keras.layers.Dense(dense, activation='relu')(drops1)  # default 128
    drops2 = tensorflow.keras.layers.Dropout(drop2, seed=0)(dense)  # default 0.2
    preds = tensorflow.keras.layers.Dense(2, activation='sigmoid')(drops2)  # default sigmoid
